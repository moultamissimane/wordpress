...
class Travel_Life_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'travel_life';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'travel-life' ), $i ),
...
// Initialize.
$travel_life_footer_widgets = new Travel_Life_Footer_Widgets();
