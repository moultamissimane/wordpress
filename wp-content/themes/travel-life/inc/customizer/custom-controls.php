 ...
 */
class Travel_Life_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Travel_Life_Dropdown_Category_Control extends WP_Customize_Control {
...
class Travel_Life_Dropdown_Taxonomy_Control extends WP_Customize_Control {
...
class Travel_Life_Note_Control extends WP_Customize_Control {
...
class Travel_Life_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Travel_Life_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="travel-life-chosen-select" <?php $this->link(); ?>>
                    <?php
...
class Travel_Life_Customize_Column extends WP_Customize_Control {
	public $type = 'hr';
 ...
 */
class Travel_Life_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Travel_Life_Customize_Sortable_Control extends WP_Customize_Control {
  ...
  public function render_content() {
    ...
    <ul class="travel-life-sortable-list">
      ...
      ?>
        ...
        <li>
            <input class="travel-life-sortable-input sortable-hideme" name="<?php echo esc_attr( $value ); ?> " type="hidden"  value="<?php echo esc_attr( $value ); ?>" />
            <span class ="menu-item-handle sortable-span"> <?php echo esc_attr( $choices[$value] ); ?> </span>
          <i class="dashicons dashicons-menu travel-life-drag-handle"></i>
        </li>
        ...
        <li class="sortable-hideme">
          <input class="travel-life-sortable-value" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
        </li>
...
class Travel_Life_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
	            ...
	            <?php } ?>
	            <input id="travel-life-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'travel-life' ); ?>" class="travel-life-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
...
class Travel_Life_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @since  1.0.0
 */
class Travel_Life_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
