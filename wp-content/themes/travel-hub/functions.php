        ...
        <table id="list">
            <tbody id="the-list" data-wp-lists="list:meta">
                <tr id="meta-8">
                    ...
                    <td class="left">
                        <input type="text" name="travel_hub_trip_amount" id="travel_hub_trip_amount" value="<?php echo esc_html($trip_amount); ?>" />
                    </td>
                </tr>
                <tr id="meta-8">
                    <td class="left">
                    ...
                    <td class="left">
                        <input type="text" name="travel_hub_trip_days" id="travel_hub_trip_days" value="<?php echo esc_html($trip_days); ?>" />
                    </td>
                </tr>
            </tbody>
        </table>
